...
export const GENERATION_STYLES: GenerationStyle[] = [
  ...
  // ── STANDARD ANIMATION ($0.07/image, fixed sizes) — 15 tokens ──
  {
    ...
    fixedSize: true, costPerGeneration: 0.07, tokenCost: 25, isAnimation: true, supportsRemoveBg: false,
  ...
  },
  {
    ...
    fixedSize: false, costPerGeneration: 0.07, tokenCost: 25, isAnimation: true, supportsRemoveBg: false,
...
export function getTokenCost(promptStyle: string): number {
  ...
  if (promptStyle.startsWith('rd_advanced_animation__')) return 25;
  if (promptStyle.startsWith('animation__')) return 25;
